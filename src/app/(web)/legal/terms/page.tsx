...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      <h1 className="text-2xl font-bold text-[#f0f4f8] mb-2">利用規約</h1>
      ...
      <div className="space-y-10 text-[#8fa3b8] text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#f0f4f8] mb-3">第1条（適用範囲）</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#f0f4f8] mb-3">第2条（アカウント登録）</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#f0f4f8] mb-3">第3条（サービス内容）</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#f0f4f8] mb-3">第4条（クレジット制度）</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#f0f4f8] mb-3">第5条（禁止事項）</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#f0f4f8] mb-3">第6条（免責事項）</h2>
          <ul className="list-disc list-inside space-y-1 text-[#8fa3b8]">
            <li>当事業者は、収集された企業データの正確性・完全性・最新性を保証するものではありません。</li>
            <li>本サービスはGoogle検索結果をもとに企業情報を収集するため、検索キーワードとの関連性が低い企業が含まれる場合があります。リストの精度は検索エンジンの結果に依存します。</li>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#f0f4f8] mb-3">第7条（サービスの変更・停止）</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#f0f4f8] mb-3">第8条（知的財産権）</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#f0f4f8] mb-3">第9条（準拠法・管轄裁判所）</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#f0f4f8] mb-3">第10条（お問い合わせ先）</h2>
      ...
      <nav className="flex justify-between items-center mt-12 pt-6 border-t border-[rgba(255,255,255,0.07)]" aria-label="法的ページナビゲーション">
        ...
        <Link href="/legal/company" className="text-sm text-[#8494a7] hover:text-[#06C755] transition-colors">
          次: 運営者情報 &rarr;
        </Link>
      </nav>
