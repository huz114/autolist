export default function TokushohoPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="overflow-hidden rounded-lg border border-gray-800">
        <table className="w-full text-sm">
          <tbody className="divide-y divide-gray-800">
            ...
            <tr>
              <th className="px-5 py-4 text-left text-gray-400 bg-gray-900/50 w-1/3 align-top font-medium">所在地</th>
              <td className="px-5 py-4 text-gray-200">請求があった場合に遅滞なく開示いたします</td>
            </tr>
            <tr>
              <th className="px-5 py-4 text-left text-gray-400 bg-gray-900/50 w-1/3 align-top font-medium">電話番号</th>
              <td className="px-5 py-4 text-gray-200">請求があった場合に遅滞なく開示いたします</td>
            </tr>
            <tr>
              <th className="px-5 py-4 text-left text-gray-400 bg-gray-900/50 w-1/3 align-top font-medium">メールアドレス</th>
              <td className="px-5 py-4 text-gray-200">info@ai-ll.co</td>
            </tr>
            <tr>
              <th className="px-5 py-4 text-left text-gray-400 bg-gray-900/50 w-1/3 align-top font-medium">販売価格</th>
              <td className="px-5 py-4 text-gray-200">
                ...
                <p className="text-gray-400 text-xs mt-2">※1クレジット＝フォームあり企業1件のリストアップ</p>
              </td>
            </tr>
            <tr>
              <th className="px-5 py-4 text-left text-gray-400 bg-gray-900/50 w-1/3 align-top font-medium">支払方法</th>
              <td className="px-5 py-4 text-gray-200">クレジットカード（Stripe決済）</td>
            </tr>
            <tr>
              <th className="px-5 py-4 text-left text-gray-400 bg-gray-900/50 w-1/3 align-top font-medium">支払時期</th>
            ...
            <tr>
              <th className="px-5 py-4 text-left text-gray-400 bg-gray-900/50 w-1/3 align-top font-medium">動作環境</th>
      ...
      <p className="text-gray-500 text-xs mt-8 text-center">オートリスト — powered by シリョログ</p>
    </div>
  )
}
