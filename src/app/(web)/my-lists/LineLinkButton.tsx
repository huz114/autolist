              ...
              <div className="space-y-5">
                ...
                <div className="bg-[#0a0f1c] border border-[rgba(255,255,255,0.07)] rounded-xl p-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <p className="text-xs text-[#8fa3b8] mb-2">QRコードを読み取るか、下のボタンから追加</p>
                      <a
                        href={LINE_BOT_FRIEND_URL}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 bg-[#06C755] hover:bg-[#04a344] text-white text-xs font-bold px-4 py-2 rounded-full transition-all"
                      >
                ...
                <div className="bg-[#0a0f1c] border border-[rgba(255,255,255,0.07)] rounded-xl p-4">
                  ...
                  <div className="bg-[#111827] border border-[rgba(6,199,85,0.3)] rounded-xl p-4 text-center">
                    <p className="text-xs text-[#8fa3b8] mb-2">以下をLINEで送信してください</p>
                    <p className="text-2xl font-mono font-bold tracking-[0.3em] text-[#f0f4f8] mb-1">
                      連携 {code}
                    </p>
                  </div>
