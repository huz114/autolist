          ...
          <div className="benefits-grid">
            {[
              ...
              },
              {
                ...
                desc: "電話番号でテレアポ。フォームURLでフォーム営業。同じリストからどちらの手法にも展開できます。CSVダウンロードで、お使いのCRMやスプレッドシートにそのまま。フォーム送信はChrome拡張がフォームへの入力を自動で行い、最後にあなたが目視で確認して送信ボタンを押すだけ。完全自動ではなく「半自動」だから、誤送信の心配がありません。",
              },
            ].map((item, i) => (
