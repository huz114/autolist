...
export default function Home() {
  ...
  const faqData = [
    ...
    {
      q: "リストの精度はどのくらいですか？",
      a: "オートリストはGoogle検索結果をもとにAIが企業情報を抽出するため、検索キーワードとの関連性が低い企業が含まれる場合があります。例えば「ホテル」で検索した際に、トラベル事業を持つIT企業がヒットするケースなどです。収集データの正確性・網羅性は検索エンジンの結果に依存しており、100%の精度を保証するものではありません。",
    },
  ];
